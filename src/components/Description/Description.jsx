      ...
      case "Spacebar":
        return (
          <>
            ...
            <p>
              My Spacebar Counter is designed to be as intuitive and user
            ...
            <p>
              ...
              <br />
              My spacebar counter&#39;s accurate measurements and simple scoring
            ...
            <h2>
              Try my spacebar counter and start improving your speed today{" "}
            </h2>
            <p>
              My spacebar counter tool is a fantastic resource for anyone
        ...
        return (
          <>
            ...
            <p>
              ...
              pad.
              <br />
              My simple scroll speed test aims to improve your scrolling speed
              and accuracy.
              <br />
              Whether you&#39;re a gamer or simply looking for a fun challenge to
              test your skills, my scroll wheel test is helpful for people
            ...
            <p>
              My simple scroll is super simple and easy to use. The test
              ...
              <br />
              To use my scroll test, hover your mouse over the grey box where
              ...
              <br />
              Once you&#39;ve stopped, my scroll test will record your highest
            ...
            <h2>Why Should You Use my Mouse Scroll Test?</h2>
            <p>
              My scroll wheel test offers several advantages to help you
        ...
        return (
          <>
            ...
            <p>
              ...
              speed.
              <br />
              With my simple scoring system, you can easily compare your scores
              with others to see who has the fastest fingers.
            </p>
            <h2 className="mt-3 mb-3">
              Try my Jitter Click Test and Start Improving Your Clicking Speed
              Today{" "}
            </h2 >
            <p>
              If you want to improve your clicking speed and measure your CPS
              accurately, try my Jitter Click Test today.
              <br />
      ...
      case "Kohi":
        return (
          <>
            ...
            <p>
              My Kohi Click Test is designed to be as simple and user friendly
            ...
            <p>
              ...
              <br />
              With my handy scoring system, the Kohi Click Test is perfect for
            ...
            <h2 className="mt-3 mb-3">
              Try my Kohi Click Speed Test and Start Improving Your Clicking
              Speed Today
            </h2>
            <p>
              If you want to improve your clicking speed and measure your CPS
              accurately, why not try my Kohi Clicking Speed Test today?
              <br />
      ...
      case "Typing":
        return (
          <>
            ...
            <p>
              My speed typing test tool is a user-friendly and engaging
              platform designed to provide you with an accurate assessment of
              your typing abilities.
            </p>
            <p>
              Whether you&#39;re a beginner or a professional, my typing test is
            ...
            <p>
              ...
              tool is the perfect place to start. By taking my typing test
            ...
            <h2>What to expect from my typing test </h2>
            <p>
              My typing test is designed to provide you with accurate results
            ...
            <p>
              ...
              typing skills? my typing test tool is perfect for just that!
              <br />
              With the ability to share my typing test directly on social
            ...
            <span>
              ...
              <p>
                ...
                to check in on your progress using my test.
                <br />
                <br />
              </p>
            ...
            <h2>
              Try my typing test and start improving your typing skills today{" "}
            </h2>
            <p>
              My typing test tool is a fantastic resource for anyone looking to
