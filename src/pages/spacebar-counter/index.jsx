...
const SpaceBar = () => {
  ...
  const description = "Measure your spacebar speed with my Spacebar Speed Test. Find out how fast you can press the spacebar key within a given time frame. Put your finger dexterity to the test and assess your speed and accuracy. ";
